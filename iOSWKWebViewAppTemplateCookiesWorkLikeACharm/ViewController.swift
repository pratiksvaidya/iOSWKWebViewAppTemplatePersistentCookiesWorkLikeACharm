...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        statusbarView.backgroundColor = UIColor(red: 0.17, green: 0.40, blue: 0.81, alpha: 1)
        ...
        if let url = URL(string: "https://app.trycents.dev/order/business/N3Jz/home") {
...
let url = URL(string: "https://app.trycents.dev/order/business/N3Jz/home")!
